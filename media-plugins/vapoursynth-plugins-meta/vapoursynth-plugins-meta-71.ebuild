...
IUSE="
	...
	vapoursynth_plugins_jincresize
...
DEPEND="${RDEPEND}
	...
	vapoursynth_plugins_bmdegrain? ( media-plugins/vapoursynth-bmdegrain )
	...
	vapoursynth_plugins_frfun7? ( media-plugins/vapoursynth-frfun7 )
	...
	vapoursynth_plugins_jincresize? ( media-plugins/vapoursynth-jincresize )
	...
	vapoursynth_plugins_mlrt-ncnn? ( media-plugins/vapoursynth-mlrt-ncnn )
	...
	vapoursynth_plugins_neo_f3kdb? ( media-plugins/vapoursynth-neo_f3kdb )
	...
	vapoursynth_plugins_wnnm? ( media-plugins/vapoursynth-wnnm )
