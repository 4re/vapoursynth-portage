...
IUSE="
	...
	vapoursynth_plugins_bm3dvk
	vapoursynth_plugins_bwdif
	vapoursynth_plugins_cambi
	vapoursynth_plugins_cas
	vapoursynth_plugins_chickendream
	...
	vapoursynth_plugins_knlmeansvk
	...
	vapoursynth_plugins_mvutensils
	vapoursynth_plugins_nnedi3vk
...
RDEPEND="
	...
	vapoursynth_plugins_bm3dvk? ( media-plugins/vapoursynth-bm3dvk )
	vapoursynth_plugins_bwdif? ( media-plugins/vapoursynth-bwdif )
	vapoursynth_plugins_cambi? ( media-plugins/vapoursynth-cambi )
	vapoursynth_plugins_cas? ( media-plugins/vapoursynth-cas )
	vapoursynth_plugins_chickendream? ( media-plugins/vapoursynth-chickendream )
	...
	vapoursynth_plugins_eedi3vk2? ( media-plugins/vapoursynth-eedi3vk2 )
	...
	vapoursynth_plugins_knlmeansvk? ( media-plugins/vapoursynth-knlmeansvk )
	...
	vapoursynth_plugins_mvutensils? ( media-plugins/vapoursynth-mvutensils )
	vapoursynth_plugins_nnedi3vk? ( media-plugins/vapoursynth-nnedi3vk )
	...
	vapoursynth_plugins_zipcl? ( media-plugins/vapoursynth-zipcl )
